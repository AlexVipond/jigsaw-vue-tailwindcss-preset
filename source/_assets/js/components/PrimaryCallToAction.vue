<template>
  ...
  >
    <svg class="inline-block h-4 w-4 fill-current" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
