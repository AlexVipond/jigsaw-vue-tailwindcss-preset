...
let colors = {
  ...
  'primary-gray-700': '#3d4852',
  'primary-gray-600': '#606f7b',
  'primary-gray-500': '#8795a1',
  'primary-gray': '#b8c2cc',
  'primary-gray-300': '#dae1e7',
  'primary-gray-200': '#f1f5f8',
  'primary-gray-100': '#f8fafc',
...
module.exports = {
  ...
  */
  ...
  modules: {
    ...
    backgroundRepeat: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    ...
    float: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    ...
    leading: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    lists: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    margin: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    maxHeight: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    ...
    negativeMargin: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    opacity: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    outline: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    overflow: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    ...
    svgFill: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    svgStroke: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    tableLayout: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
    textAlign: ['responsive', 'hover', 'focus', 'active', 'group-hover'],
